      ...
      <div className="header__middle">
        <div className="header__wrapper container">
          ...
          <div className="header__middle-buttons">
            <button className="header__middle-fav">
              <img src="./img/icons/favorites.svg" />
            </button>
        ...
        <div className="header__wrapper container">
          <div className="header__bottom-nav">
            ...
            <ul className="header__list">
              ...
              <li>
                <a href="" className="header__list-item">About Us </a>
              </li>
              <li>
                <a href="" className="header__list-item">Contact Us </a>
              </li>
            </ul>
          </div>
      ...
      <div className="container">
        <div className="props__wrapper">
          <div className="props__img">
            <img src="./img/index/props/vegetables.png" className="props__img" />
        ...
        <div className="intro-prod__wrapper">
          ...
          <div className="intro-prod__products">
            <div className="intro-prod__product">
              <p className="intro-prod__product-sale">Sale <span>50%</span></p>
        ...
        <div className="banners__wrapper">
          <div className="banners__block">
            ...
            <div className="banners__block-info">
              ...
              <p className="banners__block-pg">Starting at <span>$14.99</span></p>
